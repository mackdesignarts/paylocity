...
var _dest = {
	root	: '../Paylocity_Code_Challenge/Content/',
    index   : '../Paylocity_Code_Challenge/Views/Home/',
	styles	: '../Paylocity_Code_Challenge/Content/style/',
	images 	: '../Paylocity_Code_Challenge/Content/img/',
    fonts 	: '../Paylocity_Code_Challenge/Content/style/fonts/',
	scripts	: '../Paylocity_Code_Challenge/Content/js/'
};
...
gulp.task('copyHtml', function() { 
    ...
    return gulp.src(_src.root + '**/*.html', { base: 'public/src/' })
